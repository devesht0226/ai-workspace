...
- [product/](./product/) — vision, personas, requirements, roadmap  
- [architecture/](./architecture/) — system design, data model, API, ADRs, workflows  
- [screenshots/](./screenshots/README.md) — place UI captures for the README  

OpenAPI live docs when the API is running: http://127.0.0.1:8000/docs
